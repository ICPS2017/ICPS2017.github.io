...
$admin_send_subject     = 'Contact form alert'; // custom email subject what the admin will get as contact email alert
...
$rules = array(
    ...
    'cbxsubject' => 'trim|required',
    'cbxmessage' => 'trim|required',
);
   ...
   // $validation_message['message'] = 'This is success Process';
    ...
    if($validation_info['validation']){
       ...
       // $mail->Host = 'localhost';  // Specify main and backup SMTP servers
        ...
        //add Reply to email
        $mail->addReplyTo( $cbxemail, 'Information');
        ...
        if($cbxsendme == 'on'){
           ...
           // $mail->FromName = $admin_email_from_name;
            ...
            $mail->addReplyTo( $admin_email_to , $admin_email_to_name);
            ...
            $mail2->Subject = 'Copy Mail:'. $cbxsubject;
